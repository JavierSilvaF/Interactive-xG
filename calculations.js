...
function getPosition(Event){
    ...
    var pitchX = (x-250)*60/860,
        pitchY = (y-10)*45/460,
        leftPostXY = [263.4*60/860, 0*45/460], // xy coords of the goal
        rightPostXY = [336.6*60/860, 0*45/460],
        centreGoalXY = [300*60/860, 0*45/460],
        goalWidth = 73.2*60/860;
